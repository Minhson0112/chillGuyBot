...
class Giveaway(Base):
    ...
    type = Column(String(50), nullable=False, comment="giveaway type for tracking: daily, game, legacy, etc")
    ...
    reward_text = Column(Text, nullable=False, comment="reward description")

    status = Column(String(50), nullable=False, default="active", comment="giveaway status: active, cancelled, ended")
